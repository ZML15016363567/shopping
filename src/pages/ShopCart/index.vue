<template>
  <div class="cart">
      ...
      <div class="cart-body">
        <ul class="cart-list" v-for="(cart,index) in cartInfoList" :key="cart.id">
          ...
          <li class="cart-list-con5">
            <a href="javascript:void(0)" :aria-disabled="skuNum==1" class="mins" @click="handler('minus',-1,cart)">-</a>
            <input autocomplete="off" type="text" minnum="1" class="itxt" :value="cart.skuNum" @blur="handler('change',$event.target.value * 1,cart)">
          ...
          <li class="cart-list-con7">
            <a href="javascript:void(0)" class="sindelet" @click="deleteCartById(cart)">删除</a>
            <br>
            <a href="#none">移到收藏</a>
          </li>
        </ul>
    ...
    <div class="cart-tool">
      ...
      <div class="option">
        <a href="javascript:void(0)" @click="deletedAllCheckesCart" >删除选中的商品</a>
